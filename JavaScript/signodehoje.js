...
const verifica_data_rage = (data, data_inicio, data_fim, tipo_comparacao) =>{
...
const retorna_signo = (signos, data) => {
    ...
    for (const signo of signos){
        ...
        if(verifica_data_rage(data,data_inicio_signo,data_fim_signo,tipo_comparacao)){
            return signo["Nome"];
        }
    }
}
...
const signo_hoje = retorna_signo(colecao_signos,data_app);

console.log("O signo de hoje é: "+ signo_hoje);