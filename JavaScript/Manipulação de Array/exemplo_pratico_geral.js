...
const chuvaMeteorosHemisferioNorte = chuvaDeMeteoros.filter((chuva) => chuva.declinacao >= 0);
const chuvaMeteorosHemisferioSul = chuvaDeMeteoros.filter((chuva) => chuva.declinacao < 0);
...
chuvaMeteorosHemisferioNorte.forEach(imprimirChuva);
console.log('\n');

console.log("Chuvas no Hemisfério Sul\n");
chuvaMeteorosHemisferioSul.forEach(imprimirChuva);
